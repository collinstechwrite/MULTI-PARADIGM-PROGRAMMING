        ...
        if int(answer) == 1:
            ...
            while custom_active:
                ...
                if not find_product(custom_product):
                    ...
                    print(find_product_qty(custom_product))
                    if find_product_qty(custom_product) >= custom_count:

                        custom_sub_total = float(find_product_price(custom_product)) * int(custom_count)
                        print('The cost to you will be {} '.format(custom_sub_total))
                        data = {
                        ...
                        print('Out Of Stock {} -> {}'.format(custom_product, custom_count))
            ...
            if len(active_product_list) > 0:
                ...
                if float(total) > float(custom_budget):
                    ...
                    print(f"Total of {total} will be deducted from your budget")
                    print(f"Total of {total} added to shop")
                    print(f"Shop has {s.cash}")
            else:
